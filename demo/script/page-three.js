...
var Page3 = function (_Element) {
  _inherits(Page3, _Element);
...
_window.customElements.define(Page3.is, Page3);
...
RegisterHtmlTemplate.register("<dom-module id=page-three> <template> Page three; </template> </dom-module>");
