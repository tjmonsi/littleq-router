...
var Page4 = function (_Element) {
  _inherits(Page4, _Element);

  function Page4() {
    _classCallCheck(this, Page4);

    return _possibleConstructorReturn(this, (Page4.__proto__ || Object.getPrototypeOf(Page4)).apply(this, arguments));
  }

  _createClass(Page4, null, [{
    key: 'is',
    get: function get() {
      return 'page-four';
    }
...
_window.customElements.define(Page4.is, Page4);
...
RegisterHtmlTemplate.register("<dom-module id=page-four> <template> Page Four; </template> </dom-module>");
