...
var Page31 = function (_Element) {
  _inherits(Page31, _Element);

  function Page31() {
    _classCallCheck(this, Page31);

    return _possibleConstructorReturn(this, (Page31.__proto__ || Object.getPrototypeOf(Page31)).apply(this, arguments));
  }

  _createClass(Page31, null, [{
    key: 'is',
    get: function get() {
      return 'page-three-sub-one';
    }
  }]);
...
_window.customElements.define(Page31.is, Page31);
...
RegisterHtmlTemplate.register("<dom-module id=page-three-sub-one> <template> Page Three Sub One; </template> </dom-module>");

/***/ })

},[78]);
//# sourceMappingURL=page-three-sub-one.js.map