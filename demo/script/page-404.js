...
var Page404 = function (_Element) {
  _inherits(Page404, _Element);
...
_window.customElements.define(Page404.is, Page404);
...
RegisterHtmlTemplate.register("<dom-module id=page-404> <template> Page 404; </template> </dom-module>");
