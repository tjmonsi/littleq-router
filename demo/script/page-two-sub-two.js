...
var Page22 = function (_Element) {
  _inherits(Page22, _Element);

  function Page22() {
    _classCallCheck(this, Page22);

    return _possibleConstructorReturn(this, (Page22.__proto__ || Object.getPrototypeOf(Page22)).apply(this, arguments));
  }

  _createClass(Page22, null, [{
    key: 'is',
    get: function get() {
      return 'page-two-sub-two';
    }
  }]);
...
_window.customElements.define(Page22.is, Page22);
...
RegisterHtmlTemplate.register("<dom-module id=page-two-sub-two> <template> Page Two Sub Two </template> </dom-module>");

/***/ })

},[76]);
//# sourceMappingURL=page-two-sub-two.js.map