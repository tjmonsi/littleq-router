...
var Page1 = function (_Element) {
  _inherits(Page1, _Element);
...
_window.customElements.define(Page1.is, Page1);
...
RegisterHtmlTemplate.register("<dom-module id=page-one> <template> Page one; </template> </dom-module>");
