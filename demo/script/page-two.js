...
var Page2 = function (_Element) {
  _inherits(Page2, _Element);
...
_window.customElements.define(Page2.is, Page2);
...
RegisterHtmlTemplate.register("<dom-module id=page-two> <template> Page Two; </template> </dom-module>");
