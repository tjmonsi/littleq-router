...
var Page21 = function (_Element) {
  _inherits(Page21, _Element);

  function Page21() {
    _classCallCheck(this, Page21);

    return _possibleConstructorReturn(this, (Page21.__proto__ || Object.getPrototypeOf(Page21)).apply(this, arguments));
  }

  _createClass(Page21, null, [{
    key: 'is',
    get: function get() {
      return 'page-two-sub-one';
    }
  }]);
...
_window.customElements.define(Page21.is, Page21);
...
RegisterHtmlTemplate.register("<dom-module id=page-two-sub-one> <template> Page Two Sub One </template> </dom-module>");

/***/ })

},[74]);
//# sourceMappingURL=page-two-sub-one.js.map